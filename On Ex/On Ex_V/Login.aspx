<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="On_Ex_V.Login" %>
...
<div class="center-vertical bg-black">
    <div class="center-content row">
        <form id="form1" runat="server" class="center-margin col-xs-11 col-sm-5">
            <h3 class="text-center pad25B font-gray font-size-23">OnEx <span class="opacity-80">v1.0</span></h3>
            <div id="login-form" class="content-box">
                ...
                <div class="button-pane">
                      <asp:Button ID="btnlogin" CssClass="btn btn-block btn-primary" runat="server" 
